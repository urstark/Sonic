...
BOT_USERNAME = getenv("BOT_USERNAME", "SonicHubBot")
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/urstark/Sonic",
)
...
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/SanyaxSupport")

# Set this to True if you want the assistant to automatically leave chats after an interval
AUTO_LEAVING_ASSISTANT = bool(getenv("AUTO_LEAVING_ASSISTANT", False))

# make your bots privacy from telegra.ph and put your url here 
PRIVACY_LINK = getenv("PRIVACY_LINK", "http://sonichub.vercel.app")
...
SONG_DOWNLOAD_LIMIT = int(getenv("SONG_DOWNLOAD_LIMIT", 20))
...
STATS_IMG_URL = "https://files.catbox.moe/431fr0.jpg"
