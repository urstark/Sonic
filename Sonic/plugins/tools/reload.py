...
from Sonic.utils.database import get_assistant, get_authuser_names, get_cmode
from Sonic.utils.decorators import ActualAdminCB, AdminActual, language
from Sonic.utils.formatters import alpha_to_int, get_readable_time
...
async def restartbot(client, message: Message, _):
    ...
    if chat_id:
        ...
        try:
            db[chat_id] = []
            await Sonic.stop_stream_force(chat_id)
        except:
            pass
