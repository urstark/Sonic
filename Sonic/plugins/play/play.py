...
from Sonic.utils.decorators.language import languageCB
from Sonic.utils.decorators.play import PlayWrapper
from Sonic.utils.formatters import formats
from Sonic.utils.inline import (
    botplaylist_markup,
    livestream_markup,
    playlist_markup,
    slider_markup,
...
from Sonic.utils.logger import play_logs
...
@app.on_callback_query(filters.regex("SonicPlaylists") & ~BANNED_USERS)
@languageCB
