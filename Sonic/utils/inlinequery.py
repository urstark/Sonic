...
answer.extend(
    [
        ...
        InlineQueryResultArticle(
            title="Skip",
            description=f"Skip the current playing stream on videochat.",
            thumb_url="https://telegra.ph/file/c5952790fa8235f499749.jpg",
        ...
        InlineQueryResultArticle(
            title="Shuffle",
            description="Shuffle the current playing stream on videochat.",
            thumb_url="https://telegra.ph/file/c5952790fa8235f499749.jpg",
            input_message_content=InputTextMessageContent("/shuffle"),
        ),
        InlineQueryResultArticle(
            title="Loop",
            description="Loop the current playing stream on videochat.",
            thumb_url="https://telegra.ph/file/c5952790fa8235f499749.jpg",
